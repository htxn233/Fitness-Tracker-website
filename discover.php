                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0">
                        <div class="blog_left_sidebar">
                            <article class="blog_item">
                                ...
                                <div class="news_details">
                                    ...
                                    <ul class="blog-info-link">
                                        <li><a href="nutrion.html"><i class="fa fa-user"></i>Nutrition</a></li>
                            ...
                            <nav class="blog-pagination justify-content-center d-flex">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="discover.html" class="page-link" aria-label="Previous">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget post_category_widget">
                                <div class="filter-option">
                                    ...
                                    <select id="category-filter">
                                        ...
                                        <option href="workout.html" value="category2">Weight Loss Tips</option>
                                        <!-- Add more options for each category label -->
                                    </select>
                                </div>
                            </aside>
                            ...
                            <aside class="single_sidebar_widget tag_cloud_widget">
                                ...
                                <ul class="list">
                                    <li>
                                        <a href="nutrion.html">Nutrition</a>
                                    </li>
                                    <li>
                                        <a href="workout.html">Workout tips</a>
                                    </li>
                                    <li>
                                        <a href="sport.html">Sports and activities</a>
                                    </li>
                                    <li>
                                        <a href="f_movation.html">Fitness motivation</a>
                                    </li>
                                    <li>
